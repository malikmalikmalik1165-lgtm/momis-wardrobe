  ...
  const sections = [
    ...
    },
    {
      ...
      steps: [
        ...
        "2️⃣ '⬇ Download Template' par click karein — momis-products-template.xlsx download hogi",
        "",
        "📋 TEMPLATE COLUMNS:",
        ...
        "",
        "3️⃣ Apne saare products template mein likhein (Markaz/Daraz se copy-paste kar sakte hain)",
        "4️⃣ Import modal mein file select karein ya drag & drop karein (.xlsx, .xls, .csv)",
        "5️⃣ PREVIEW dikhega — kitni rows import hongi, kaun si skip hongi",
        "6️⃣ 'Import' button tap karein → ✅ result message aayega",
        "",
        "💡 TIPS:",
        "   → Google Sheets se bhi import kar sakte hain: File → Download → Excel (.xlsx)",
        "   → Header row ke naam change NA karein — template ke hi columns use karein",
        "   → Bina Name/Price wali rows skip ho jayengi (preview mein pehle dikhti hain)",
